...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        */
        ...
        TextView numberTextView = (TextView) listItemView.findViewById(R.id.Movie_name);
        // Get the version number from the current AndroidFlavor object and
        // set this text on the number TextView
        numberTextView.setText(currentAndroidFlavor.getMovieName());
        ...
        imageView1.setImageResource(currentAndroidFlavor.getsPlayResource());

        View textContainer=listItemView.findViewById(R.id.text_container);
        int color= ContextCompat.getColor(getContext(),sColorResource);
